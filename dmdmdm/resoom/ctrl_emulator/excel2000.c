...
static CA_INTERFACEDATA _RefreshEvents_CA_INTERFACEDATA =
    {
        ...
        sizeof (_RefreshEvents_CA_METHODDATA) / sizeof (*_RefreshEvents_CA_METHODDATA)
    };
...
static CA_INTERFACEDATA _AppEvents_CA_INTERFACEDATA =
    {
        ...
        sizeof (_AppEvents_CA_METHODDATA) / sizeof (*_AppEvents_CA_METHODDATA)
    };
...
static CA_INTERFACEDATA _ChartEvents_CA_INTERFACEDATA =
    {
        ...
        sizeof (_ChartEvents_CA_METHODDATA) / sizeof (*_ChartEvents_CA_METHODDATA)
    };
...
static CA_INTERFACEDATA _DocEvents_CA_INTERFACEDATA =
    {
        ...
        sizeof (_DocEvents_CA_METHODDATA) / sizeof (*_DocEvents_CA_METHODDATA)
    };
...
static CA_INTERFACEDATA _WorkbkEvents_CA_INTERFACEDATA =
    {
        ...
        sizeof (_WorkbkEvents_CA_METHODDATA) / sizeof (*_WorkbkEvents_CA_METHODDATA)
    };
...
static CA_INTERFACEDATA _OLEObjectEvents_CA_INTERFACEDATA =
    {
        ...
        sizeof (_OLEObjectEvents_CA_METHODDATA) / sizeof (*_OLEObjectEvents_CA_METHODDATA)
    };
...
HRESULT CVIFUNC Excel_SetProperty (CAObjHandle objectHandle,
                                   ERRORINFO *errorInfo, unsigned int propertyID,
...
HRESULT CVIFUNC Excel_SetPropertyByRef (CAObjHandle objectHandle,
                                        ERRORINFO *errorInfo,
